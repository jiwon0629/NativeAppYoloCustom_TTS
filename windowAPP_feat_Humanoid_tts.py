...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # 직렬 포트 초기화
        self.ser = serial.Serial('COM4', 115200)  # 포트와 속도는 환경에 맞게 설정 (Windows에서는 COM 포트 사용, Linux/Mac에서는 '/dev/ttyUSB0' 등 사용)
    ...
    def video_pred(self):
        ...
        if not ret:
            ...
            self.output.setPixmap(QPixmap.fromImage(self.convert2QImage(image)))
